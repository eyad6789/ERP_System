...
urlpatterns = [
    ...
    path("api/recruitment/", include("modules.recruitment.interfaces.urls")),
    path("api/performance/", include("modules.performance.interfaces.urls")),
    path("api/training/", include("modules.training.interfaces.urls")),
